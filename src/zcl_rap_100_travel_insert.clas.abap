CLASS zcl_rap_100_travel_insert DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap_100_travel_insert IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap_100_travel.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap_100_travel  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zrap_100_travel. | ).
  ENDMETHOD.
ENDCLASS.
